...
export const Header = () => {
  ...
  const [darkMode, setDarkMode] = useState(localStorage.setItem("darkMode", JSON.stringify("darkMode")) || false);
  ...
  return (
    <header>      
      <nav className="bg-white border-gray-200 border-b-2 dark:bg-gray-900 dark:border-gray-500 dark:border-2">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
          <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
              <img src={Logo} className="h-12 rounded-full" alt="Cinemate Logo" />
